...
public class DBConnectionUtil extends CommonUtil {
	...
	public static Connection getDBConnection() throws ClassNotFoundException, SQLException {
		...
		if (connection == null || connection.isClosed()) {
			...
			Class.forName(properties.getProperty(ProjectConstants.DRIVER_NAME));
			connection = DriverManager.getConnection(properties.getProperty(ProjectConstants.URL),
					properties.getProperty(ProjectConstants.USERNAME), properties.getProperty(ProjectConstants.PASSWORD));
		}
		return connection;
	}
}
