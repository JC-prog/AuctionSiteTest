<%@page import="com.service.RegisterInterfaceImpl"%>
<%@page import="com.service.RegisterInterface"%>
...
<br><br><br><br>
	        ...
	        <div class="container text-center">
				...
				RegisterInterface iRegisterService = new RegisterInterfaceImpl();
						ArrayList<RegisterClass> arraList = iRegisterService.getuUser();
						
						for(RegisterClass registerClass : arraList) {
            	%>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <h4 class="text text-info"><%=registerClass.getuId() %></h4>
                </div>
            </div>
				<br>
            <div class="row">
                ...
                <div class="col-8">
                    <h4 class="text text-info"><%=registerClass.getuName() %></h4>
                </div>
            </div> 
            <br>
            <div class="row">
                ...
                <div class="col-8">
                    <h4 class="text text-info"><%=registerClass.getuMail() %></h4>
                </div>
            </div>
            <div class="row">
            	...
            	<div class="col-lg-6">
	            	<div class="container">
				        <form action="GetUserServlet" method="POST">
				        		<input type="hidden" name="catNo" value="<%=registerClass.getuId()%>" />
